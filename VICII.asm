...
VIC_CHARSET_MULTICOLOR_1 = $D022        ; (53282) Extra Background Color 1 
VIC_CHARSET_MULTICOLOR_2 = $D023        ; (53283) Extra Background Color 2
...
VIC_SPRITE_COLOR        =  $D027        ; (53287) Sprite #0 Color
